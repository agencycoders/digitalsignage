...
export const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Sidebar */}
      <aside className="w-64 bg-[var(--color-bg-dark)] border-r border-[var(--color-border)] flex flex-col">
        {/* Logo */}
        <div className="p-6 border-b border-[var(--color-border)]">
          <h1 className="text-xl font-bold">TV Corporate</h1>
        </div>
        ...
        <div className="p-4 border-t border-[var(--color-border)]">
          <div className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-[var(--color-bg-light)]">
